...
- **MRL 母體吸收成長閉環 (`MRL_MotherGrowthLoop_v1`)**: 蒸餾 Seed 版本化、驗證、回滾、MQM export 與下一任務記憶注入
...
# MRL_MotherGrowthLoop_v1（Windows / DL580）
...
Firebase 血統產物的正式名稱、平台定位名與回收狀態見
[`docs/MRL_Firebase_Lineage_Naming_v1.md`](docs/MRL_Firebase_Lineage_Naming_v1.md)。
