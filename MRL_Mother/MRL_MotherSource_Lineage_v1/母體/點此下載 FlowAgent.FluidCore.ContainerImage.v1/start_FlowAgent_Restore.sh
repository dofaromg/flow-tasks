#!/bin/bash
echo "🔄 MrLiouAI 系統一鍵重建啟動中..."

# 解壓必要封包（假設已存在於 /mnt/data/ ）
unzip -o "/mnt/data/點此下載 MrLiouAI.EchoBody.RestorePack.v1.zip" -d "./restorepack"
